...
export default function NavbarComponent() {
  // Stato per tenere traccia dello stato di login dell'utente
  ...
  useEffect(() => {
    ...
    // Eseguo il controllo iniziale dello stato di login
    checkLoginStatus();
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            {isLoggedIn ? (
              ...
              // Mostro questi elementi se l'utente è loggato
              <>
              ...
              // Mostro questi elementi se l'utente non è loggato
              <>
